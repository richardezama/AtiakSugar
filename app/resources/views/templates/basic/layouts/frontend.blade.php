...
<head>
    ...
    <!-- own templates -->
    <link rel="stylesheet" href="{{asset($activeTemplateTrue.'css/owl/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{asset($activeTemplateTrue.'css/owl/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{asset($activeTemplateTrue.'slick/slick.css') }}">
    @stack('style-lib')
...
<body>
    ...
    <script src="{{asset($activeTemplateTrue.'slick/slick.min.js') }}"></script>
