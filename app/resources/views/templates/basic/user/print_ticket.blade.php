                        ...
                        <table class="">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <h5 class="value">{{ __($ticket->vehicle->nick_name) }}</h5>
                                    </td>
                                </tr>
                    ...
                    <div class="p-50 ticket-body-part">
                        <table class="">
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-left">
                                        <p class="title">@lang('Car Brand')</p>
                                    </td>
                                    <td>
                                        <b>:</b>
                                    </td>
                                    <td class="text-right">
                                        <h5 class="value">
                                            ...
                                            {{ __($ticket->vehicle->brand->name) }}</h5>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="text-left">
                                        <p class="title">@lang('Number Plate')</p>
                                    </td>
                                    <td>
                                        <b>:</b>
                                    </td>
                                    <td class="text-right">
                                        <h5 class="value">{{ __($ticket->vehicle->register_no) }}</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-left">
                                        <p class="title">@lang('Fare')</p>
                                    </td>
                                    <td>
                                        <b>:</b>
                                    </td>
                                    <td class="text-right">
                                        <h5 class="value">
                                            ...
                                            {{ __(showAmount($deposit->final_amo)) }}
                                            {{ __($general->cur_text) }}
