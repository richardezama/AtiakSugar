            ...
            <div class="account-form-wrapper">
                <div class="account-header">
                    <div class="left-content">
                         ...
                         <h3 class="title">Welcome Back! Dear Client</h3>
                        <span>{{ __(@$content->data_values->sub_heading) }}</span>
                    </div>
                </div>
                    <form method="POST" class="account-form row" 
                    action="{{ route('admin.login')}}" onsubmit="return submitUserForm();">
                    @csrf
                    <div class="col-lg-12">
                        <div class="form--group">
                            <label for="username">@lang('Username')</label>
                            <input id="username" name="username" type="text" 
                            class="form--control" placeholder="@lang('Enter Your username')" required>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form--group">
