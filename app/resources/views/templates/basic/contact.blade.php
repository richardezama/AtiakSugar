            ...
            <div class="col-sm-6 col-lg-4">
                <div class="info-item">
                    ...
                    <div class="content">
                        ...
                        <a href="mailto:icytreyrichards@yahoo.com">icytreyrichards@yahoo.com</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row gy-5">
            ...
            <div class="col-lg-6">
                <div class="map-wrapper">
                    <iframe class="map" style="border:0;" src="https://maps.google.com/maps?q=0.3476,32.5825&hl=es;z=14&amp;output=embed"></iframe>
                </div>
            </div>
        </div>
    </div>
