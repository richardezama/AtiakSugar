...
<head>
    ...
    <!-- site favicon -->
    <link rel="shortcut icon" type="image/png" href="{{asset('arnet.jpg')}}">
...
<script src="https://maps.googleapis.com/maps/api/js?sensor=false &key=AIzaSyBlSEfNMZgv3t_Q2TryXTP1Rb34HnvSBqo" type="text/javascript"></script>
