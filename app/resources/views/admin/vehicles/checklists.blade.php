    ...
    <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.vehicles.checklist.store')}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold"> @lang('Checklist Tyope')</label>
                            <div class="input-group">
                                <select class="select2-basic" name="checklist_type" required>
    ...
    <div id="disableModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.vehicles.checklist.disable')}}" method="POST">
                    @csrf
                    <input type="text" name="id" hidden="true">
                    <div class="modal-body">
    ...
    <script>
        (function ($) {
            ...
            $(document).on('click', '.editBtn', function () {
                ...
                var link    = `{{ route('admin.vehicles.checklist.update', '') }}/${data.id}`;
