                ...
                <div class="card-body">
                    <div class="accordion" id="accordionExample">
                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionExample">
                            ...
                            <form method="post" action="{{ route('admin.supportticket.reply', $my_ticket->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row border border-warning border-radius-3 my-sm-3 my-2 py-3 mx-0 mx-sm-2" style="background-color: #ffd96729">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="mt-2">
                                                @foreach($message->attachments as $k=> $image)
                                                <a href="{{route('admin.supportticket.download',encrypt($image->id))}}" class="mr-3"><i class="fa fa-file"></i> @lang('Attachment') {{++$k}} </a>
                                                @endforeach
                                            </div>
                                            @endif
                                        </div>
...
<div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{ route('admin.supportticket.reply', $my_ticket->id) }}">
                @csrf
