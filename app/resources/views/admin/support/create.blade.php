        ...
        <div class="card b-radius--10 ">
            <div class="card cmn--card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center" style="gap:7px">
                    ...
                    <a href="{{route('admin.supportticket.support_ticket') }}" class="btn btn-sm bg-white float-right support-ticket">
                        @lang('My Support Ticket')
                    </a>
                </div>

                <div class="card-body">
                    <form action="{{route('admin.supportticket.store')}}" method="post" enctype="multipart/form-data" onsubmit="return submitUserForm();">
                        @csrf
                        <div class="row gy-3">
                            <div class="form-group col-md-6">
                                <label class="form-label" for="name">@lang('Name')</label>
                                <input type="text" name="name" value="{{@$user->name}}" class="form--control" placeholder="@lang('Enter your name')" readonly>
                            </div>
                            <div class="form-group col-md-6">
