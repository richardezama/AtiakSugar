                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($items as $item)
                                ...
                                <!--<td data-label="@lang('No')">
                                        ...
                                        @if($item->photo!="")
                                        <img src="{{asset('uploads/'.$item->photo)}}" class="img-responsive"  width="100" height="70"/>
                                        @endif
                                    </td>-->
                ...
                >
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="form-group">
                                <label class="form-control-label  font-weight-bold">@lang('Product Code') 
    ...
    <script>
        (function ($) {
            ...
            $(document).on('click', '.editBtn', function () {
               ...
               var link    = `{{ route('admin.products.update', '') }}/${data.id}`;
