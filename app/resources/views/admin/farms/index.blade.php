                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($items as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Latitude')">
                                        {{ __($item->latitude) }}
                                    </td>   
                                    <td data-label="@lang('Longitude')">
                                        {{ __($item->longitude) }}
                                    </td>   
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> @lang('Add Farm')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('admin.farms.store')}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold"> @lang('Latitude')</label>
                            <input type="text" class="form-control" placeholder="@lang('Latitude')" name="latitude" required>
                        </div>

                        <div class="form-group">
                            <label class="form-control-label font-weight-bold"> @lang('Longitude')</label>
                            <input type="text" class="form-control" placeholder="@lang('Longitude')" name="longitude" required>
                        </div>
    ...
    <div id="disableModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.farms.delete')}}" method="POST">
                    @csrf
                    <input type="text" name="id" hidden="true">
                    <div class="modal-body">
    ...
    <script>
        (function ($) {
            ...
            $(document).on('click', '.editBtn', function () {
                ...
                var link    = `{{ route('admin.farms.update', '') }}/${data.id}`;
