                            ...
                            @forelse($steering as $item)
                                <tr>
                                    <td data-label="@lang('Name')">
                                        ...
                                        {{ __($item->name) }}
                                        &nbsp
                                        <img width="50" height="50" alt="." src="{{asset('storage/')."/".$item->logo}}"/>
            ...
            <div class="modal-content">
                ...
                method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold"> @lang('Vehicle Photo')</label>
    ...
    <script>
        (function ($) {
            ...
            $(document).on('click', '.editBtn', function () {
                ...
                var link    = `{{ route('admin.brand.update', '') }}/${data.id}`;
