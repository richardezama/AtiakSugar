...
class DepositController extends Controller
{
    ...
    public function successful(){
        ...
        $deposits = Deposit::Successful()->with($this->depoRelations);
    ...
    public function rejected(){
        ...
        $deposits = Deposit::rejected()->with($this->depoRelations);
    ...
    public function all(){
        ...
        $deposits = Deposit::with($this->depoRelations,'company')->paginate(getPaginate());
    ...
    public function approve(Request $request)
    {
        ...
        notify($user, 'PAYMENT_APPROVE', [
            ...
            'total_seats' =>$bookedTicket->seats,
            'source' => "",
            'destination' => ""
        ]);
