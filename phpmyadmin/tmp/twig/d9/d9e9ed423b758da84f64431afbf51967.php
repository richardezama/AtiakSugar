...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/Applications/XAMPP/xamppfiles/phpmyadmin/templates/database/structure/bulk_action_modal.twig");
    }
}
